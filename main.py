...
async def get_ai_response(message: str, context: List[dict] = None) -> str:
    ...
    system_prompt = """You are a helpful AI customer support agent. You should:
    ...
    5. Try to resolve customer issues efficiently
    6. Keep responses conversational and natural for voice interaction
    7. Respond in the same language as the user (Hindi/English)"""
